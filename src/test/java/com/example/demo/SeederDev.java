...
public class SeederDev {
    ...
    private void seedDataBase() {
        ...
        BookEntity[] bookEntities = {
                BookEntity.builder().bookID("1").name("test").entryTime(LocalDateTime.now()).description("this is a test book").status(BookStatus.ENABLE).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("12")).language(Language.English).authorId(List.of(authorEntities[0].getAuthorId())).bookType(List.of(typeEntities[0].getName())).build(),
                BookEntity.builder().bookID("2").name("test1").entryTime(LocalDateTime.now()).description("this is a test book1").status(BookStatus.ENABLE).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("32")).language(Language.Spanish).authorId(List.of(authorEntities[1].getAuthorId())).bookType(List.of(typeEntities[1].getName())).build(),
                BookEntity.builder().bookID("3").name("test2").entryTime(LocalDateTime.now()).description("this is a test book2").status(BookStatus.OCCUPIED).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("55")).language(Language.English).authorId(List.of(authorEntities[2].getAuthorId(),authorEntities[3].getAuthorId())).bookType(List.of(typeEntities[2].getName(),typeEntities[3].getName())).build(),
                BookEntity.builder().bookID("4").name("test3").entryTime(LocalDateTime.now()).description("this is a test book3").status(BookStatus.OCCUPIED).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("99")).language(Language.English).authorId(List.of(authorEntities[2].getAuthorId(),authorEntities[3].getAuthorId())).bookType(List.of(typeEntities[3].getName(),typeEntities[4].getName())).build(),
                BookEntity.builder().bookID("5").name("test4").entryTime(LocalDateTime.now()).description("this is a test book4").status(BookStatus.OCCUPIED).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("64")).language(Language.English).authorId(List.of(authorEntities[0].getAuthorId(),authorEntities[2].getAuthorId())).bookType(List.of(typeEntities[4].getName())).build(),
                BookEntity.builder().bookID("6").name("test5").entryTime(LocalDateTime.now()).description("this is a test book5").status(BookStatus.ENABLE).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("64")).language(Language.English).authorId(List.of(authorEntities[0].getAuthorId(),authorEntities[2].getAuthorId())).bookType(List.of(typeEntities[4].getName())).build(),
                BookEntity.builder().bookID("7").name("test6").entryTime(LocalDateTime.now()).description("this is a test book6").status(BookStatus.ENABLE).imgUrl("https://localhost/images/book/default.jpg").imgFileName("default.jpg").deposit(new BigDecimal("64")).language(Language.English).authorId(List.of(authorEntities[0].getAuthorId(),authorEntities[2].getAuthorId())).bookType(List.of(typeEntities[4].getName())).build(),
        };
